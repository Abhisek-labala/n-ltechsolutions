...
export default function TestimonialsManager({ testimonials: initial }: { testimonials: TestimonialData[] }) {
  ...
  const renderRow = useCallback((t: TestimonialData) => (
    <>
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">{initial.length} testimonials</p>
        </div>
      </div>
