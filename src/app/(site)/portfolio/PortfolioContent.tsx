  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group relative h-full flex flex-col glass-card-premium rounded-2xl p-5 transition-all duration-500 hover:shadow-[0_0_35px_rgba(6,182,212,0.18)] dark:hover:shadow-[0_0_40px_rgba(6,182,212,0.22)] border border-gray-200/80 dark:border-white/[0.08] hover:border-teal/50 dark:hover:border-teal/50"
      >
        ...
        {/* Top Mockup Header with Neon Gradient */}
